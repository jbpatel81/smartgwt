...
public abstract class ShowcasePanel extends VLayout {
    ...
    public void showSource(SourceEntity[] sourceUrls, int width, int height, boolean useDesktopMode) {
    ...
    public void setBetaMessage(String message) {
        this.betaMessage = message;
    }

    public void showOverview(boolean useDesktopMode) {
        final boolean topIntro = isTopIntro();
